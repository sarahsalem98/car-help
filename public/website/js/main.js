...
$(document).on('click', '.repeater-add-btn', function() {
  ...
  $('.provider_items').append(`
    <div class="provider_time_row">
        <input type="text" class="day_input provider_input" placeholder="السبت">
        <div class="time-form-group">
            <input type="time" class="time_input hidden_input">
        ...
        <label class="close_label mb-0"> 
            <input type="checkbox" class="close_checkbox" name="time">
            مغلق
        </label>
