                ...
                <table class="table table-actions-bar m-b-0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><img src="{{asset('images/products/iphone.jpg')}}" class="thumb-sm pull-left m-r-10" alt=""> Apple iPhone </td>
                        ...
                        <tr>
                            ...
                            <td><img src="{{asset('images/products/samsung.jpg')}}" class="thumb-sm pull-left m-r-10" alt=""> Samsung Phone </td>
                        ...
                        <tr>
                            <td><span data-plugin="peity-line" data-fill="#fff" data-stroke="#5fbeaa" data-width="80" data-height="30">5,3,9,6,5,9,7,3,5,2</span>
                                <td><img src="{{asset('images/products/imac.jpg')}}" class="thumb-sm pull-left m-r-10" alt=""> Apple iPhone </td>
                        ...
                        <tr>
                            ...
                            <td><img src="{{asset('images/products/macbook.jpg')}}" class="thumb-sm pull-left m-r-10" alt=""> Apple iPhone </td>
                        ...
                        <tr>
                            ...
                            <td><img src="{{asset('images/products/lumia.jpg')}}" class="thumb-sm pull-left m-r-10" alt=""> Lumia iPhone </td>
                            <td><span class="text-custom">+$230</span></td>
                            <td>
                                <a href="#" class="table-action-btn"><i class="md md-edit"></i></a>
                                <a href="#" class="table-action-btn"><i class="md md-close"></i></a>
