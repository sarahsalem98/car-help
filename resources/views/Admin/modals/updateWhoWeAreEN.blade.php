...
<div id="update-whoWeAreEn" class="modal-demo">
            <button type="button" class="close btnclose" onclick="Custombox.close();">
                <span>&times;</span><span class="sr-only">Close</span>
            </button>
            <h4 class="custom-modal-title ">    تعديل من نحن بالانجليزية </h4>
            <div class="custom-modal-text text-right">
                <form role="form" method="POST" action="{{route('whoWeAre.update')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="who_are_we_en" class="form-control" placeholder="ادخل اسم هنا" id="" cols="30" rows="10">
                        
                        {{old('who_are_we_en',$whoWeAre->who_are_we_en ?? null)}}
                        </textarea>
