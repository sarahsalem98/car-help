            ...
            <div class="card-box">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                             ...
                             <a href="#add-brand" class="btn btn-default btn-md waves-effect waves-light m-b-30 btnopen" data-animation="fadein" data-plugin="custommodal" 
                                                    	data-overlaySpeed="200" data-overlayColor="#36404a"><i class="md md-add"></i> اضافة  عنصر جديد لانواع البراندات</a>
                         </div>
