...
@section('provider.order.product.complete.show')
        ...
        <div class="order_details">
            ...
            <div class="rating_body p-10-16">
                <div class="stars_wrapper">
                    ...
                    <!-- fa fa-star star-{{$rate[$i]}} {{$service->comment->rate<=$i?'rated-star':''}}
                    {{$service->comment->rate}} -->
                        @endfor
                    <!-- <i class="fa fa-star star-one rated-star"></i>
                    <i class="fa fa-star star-two rated-star"></i>
                    <i class="fa fa-star star-three rated-star"></i>
                    <i class="fa fa-star star-four rated-star"></i>
