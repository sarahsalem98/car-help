...
@section('provider.verify')
  ...
  <div class="inner_pages_top">
     ...
     <div class="login_section">
        <div class="container">
            <form action="{{route('provider.verify.post')}}" method="POST" class="login_form">
                @csrf
                ...
                <div class="row code_inputs">
                    <input type="hidden" name="phone_number" value="{{$provider->phone_number}}">
                   <div class="col-xs-3">
