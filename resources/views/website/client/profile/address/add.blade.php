...
@section('client.profile.address.add')
<div class="inner_pages_top">
        <h3 class="inner-pages-title">اضافة العنوان</h3>
        <ol class="breadcrumb">
            <li><a href="{{route('main')}}"> <i class="flaticon-home"></i> الرئيسية</a></li>
            <li><a href="{{route('client.address')}}"> العناوين</a></li>
            <li class="active">اضافة العنوان</li>
          </ol>
    </div>
     <!--start contact us-->
     <div class="login_section">
        <div class="container edit_address_wapper">
            <h5 class="sections-title mb-14">اضافة العنوان</h5>
            @include('website.alertSuccess')
            <div class="row">
                <div class="col-xs-12 col-lg-10">
                    <form action="{{route('client.address.add.post')}}" class="address_form" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="lat"  placeholder="lat" id="lat">
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <textarea class="form-control" name="notes" placeholder="الرجاء ادخال ملاحظات"></textarea>
                            </div>
                            <div class="col-xs-12">
                                <button type="submit" class="btn main_btn moving_bk submit_btn" > اضافة</button>
                            </div>
                          </div>
                    </form>
                </div>
